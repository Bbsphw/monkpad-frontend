...
// import type { TrafficAreaPoint } from "../_types/dashboard"; // ✅ ใช้ type สำหรับกราฟ
// import {
//   CustomTooltip,
...
//   data: TrafficAreaPoint[]; // ✅ ต้องมี date,income,expense
//   className?: string;
//   isLoading?: boolean;
//   title?: string;
//   description?: string;
...
export interface TrafficAreaChartProps {
  data: TrafficAreaPoint[]; // date(YYYY-MM-01), income, expense
  className?: string;
  isLoading?: boolean;
  title?: string;
  description?: string;
