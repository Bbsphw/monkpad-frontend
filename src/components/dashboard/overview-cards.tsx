...
function accentCardClasses(accent: Accent | undefined): {
  ...
  switch (accent) {
    case "success":
      return {
        card:
          // ไล่สีอ่อน + เส้นขอบกลืนโทน (รองรับ dark)
...
export interface OverviewCardsProps {
  /** รายการการ์ด หากไม่ส่งมา จะใช้ mock ด้านล่าง */
  items?: StatMetric[];
  /** แสดง skeleton ระหว่างโหลด */
  isLoading?: boolean;
  /** คำอธิบายใต้การ์ด (ถ้าต้องการ) จัดส่งตาม index */
  descriptions?: string[];
}
...
export function OverviewCards({
  ...
  // mock เริ่มต้น (สอดคล้อง SRS): รายรับ, รายจ่าย, คงเหลือ, จำนวนธุรกรรม
